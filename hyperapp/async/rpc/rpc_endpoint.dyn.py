...
class RpcEndpoint:
    ...
    def __init__(self, async_web, mosaic, types, peer_registry, transport, python_object_acreg):
        self._mosaic = mosaic
        self._types = types
        self._peer_registry = peer_registry
        self._transport = transport
        self._python_object_acreg = python_object_acreg
    ...
    async def _handle_error_response(self, response, transport_request):
        log.info("Process rpc error response: %s", response)
