...
class Proxy:
    ...
    async def _run_request(self, method_name, method, *args, **kw):
        ...
        await self._transport.send(self._peer, self._my_identity, [request_ref])
        result = await self._rpc_endpoint.wait_for_response(request_id)
...
class ThisModule(Module):
    ...
    def __init__(self, module_name, services, config):
        ...
        services.async_rpc_proxy = self.rpc_proxy_factory
