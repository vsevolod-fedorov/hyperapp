...
class ThisModule(Module):
    ...
    def __init__(self, module_name, services, config):
        ...
        services.available_view_registry.add_view(StringObject.dir_list[-1], htypes.line_edit.line_edit_view(editable=False))
        services.available_view_registry.add_view(StringObject.dir_list[-1], htypes.line_edit.line_edit_view(editable=True))
