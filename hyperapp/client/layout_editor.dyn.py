...
class LayoutEditor(TreeObject):
    ...
    @classmethod
    async def from_object_state(cls, state, async_ref_resolver, object_registry, view_producer_registry, object_layout_overrides, object_layout_resolver):
        ...
        layout_root = ObjectLayoutRoot(object_layout_overrides, layout, state.piece_ref, object)
...
class ThisModule(ClientModule):
    ...
    def __init__(self, module_name, services):
        ...
        services.object_registry.register_type(
            ...
            services.object_layout_overrides, services.object_layout_resolver)
