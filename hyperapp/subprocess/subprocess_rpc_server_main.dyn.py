...
def rpc_server_main(
        bundler, peer_registry, route_table, generate_rsa_identity, endpoint_registry, rpc_endpoint_factory, rpc_call_factory, subprocess_transport,
    ...
    subprocess_transport.add_server_connection('master', connection, received_refs, on_eof=on_close, on_reset=on_close)
