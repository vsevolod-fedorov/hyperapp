...
def crud_commit_command_enum(view, system_fn_creg, error_view, view_reg, visualizer):
    model_command = view.unbound_commit_command
    ui_command = wrap_model_command_to_ui_command(error_view, view_reg, visualizer, model_command)
    return [ui_command]
