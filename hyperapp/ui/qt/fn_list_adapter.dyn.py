...
class FnListAdapter(FnListAdapterBase):
    ...
    @classmethod
    def from_piece(cls, piece, model, ctx, rpc_call_factory, feed_factory):
        element_t = pyobj_creg.invite(piece.element_t)
        fn = pyobj_creg.invite(piece.function)
        return cls(rpc_call_factory, feed_factory, model, element_t, piece.params, ctx, piece.function, fn)

    def __init__(self, rpc_call_factory, feed_factory, model, item_t, params, ctx, fn_res_ref, fn):
