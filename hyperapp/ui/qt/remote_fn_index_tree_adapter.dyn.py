...
class RemoteFnIndexTreeAdapter(FnIndexTreeAdapterBase):
    ...
    def from_piece(cls, piece, model, ctx, feed_factory):
        ...
        return cls(feed_factory, model, element_t, piece.params, ctx, piece.function, ctx.rpc_endpoint, ctx.identity, remote_peer)

    def __init__(self, feed_factory, model, item_t, params, ctx, fn_res_ref, rpc_endpoint, identity, remote_peer):
