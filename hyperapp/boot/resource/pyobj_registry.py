...
def register_pyobj_creg_actors(pyobj_creg, mosaic, web, python_importer, source_path, builtin_name_to_service):
    ...
    pyobj_creg.register_actor(partial_t, partial_pyobj, pyobj_creg=pyobj_creg, web=web)
