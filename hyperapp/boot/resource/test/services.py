...
from hyperapp.boot.htypes import list_mt, optional_mt
...
from hyperapp.boot.resource.optional_mt_resource_type import OptionalMtResourceType
...
def resource_type_reg():
    ...
    reg[optional_mt] = OptionalMtResourceType()
