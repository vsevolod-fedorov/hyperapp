...
class MetaTypeTest(unittest.TestCase):
    ...
    def test_named( self ):
        data = t_named('int')
        t = self.type_registry.resolve(builtin_type_registry(), data)
    ...
    def test_hierarchy( self ):
        ...
        hierarchy = self.type_registry.resolve(type_names, hdata)
        ...
        class_a = self.type_registry.resolve(type_names, cdata_a)
        type_names.register('my_class_a', class_a)
        class_b = self.type_registry.resolve(type_names, cdata_b)
    ...
    def test_interface( self ):
        ...
        t = self.type_registry.resolve(type_names, data)
