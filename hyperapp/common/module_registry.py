...
class CodeModule:
    ...
    def get_sub_loader_dict(self, imported_module_dict, module_name):
        return {
    ...
    def _get_code_sub_loader_dict(self, imported_module_dict):
        for import_name, module in self._code_import_list:
            python_module = imported_module_dict[module]
