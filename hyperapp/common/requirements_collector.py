...
class RequirementsCollector(Visitor):
    ...
    def __init__(self, error_types, packet_types, core_types, param_editor_types, iface_registry):
        Visitor.__init__(self, error_types, packet_types, core_types, iface_registry)
