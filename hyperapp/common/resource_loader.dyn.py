...
class ResourceLoader(object):
    ...
    def __init__(self, mosaic, types, local_type_module_registry, local_code_module_registry, resource_registry):
        self._mosaic = mosaic
        self._types = types
    ...
    def _load_resource_section_elements(self, locale, base_ref, section_type, path, item_elements):
        for item_id, items in item_elements.items():
            ...
            resource_ref = self._mosaic.distil(resource)
    ...
    def _value2layout(self, section_contents):
        ...
        layout_ref = self._mosaic.distil(layout)
    ...
    def _value2layout_view(self, value):
        ...
        view_ref = self._mosaic.distil(view, t)
