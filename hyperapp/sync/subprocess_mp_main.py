...
def subprocess_main(process_name, connection, additional_module_dirs, code_module_list, config):
    with logging_inited(process_name):
        try:
            subprocess_main_safe(connection, additional_module_dirs, code_module_list, config)
...
def subprocess_main_safe(connection, additional_module_dirs, code_module_list, config):
    services = Services()
