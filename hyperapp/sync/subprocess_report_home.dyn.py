...
class ThisModule(Module):
    ...
    def __init__(self, module_name, services, config):
        ...
        rpc_call = services.rpc_call_factory(rpc_endpoint, master_peer, master_servant_ref, my_identity, timeout_sec=20)
    ...
    def start(self):
        log.info("Start report home start signal thread")
        self._thread.start()

    def stop(self):
        log.info("Stop report home signal thread")
        self._thread.join()
        log.info("Report home start signal thread is stopped")
