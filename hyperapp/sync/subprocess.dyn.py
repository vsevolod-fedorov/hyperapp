...
class ThisModule(Module):
    ...
    def subprocess(self, process_name, module_dir_list, code_module_list=None, config=None):
        ...
        args = [process_name, child_connection, module_dir_list, code_module_list or [], config]
