...
class _RpcServerProcess:
    ...
    def __init__(self, id, name, connection, peer, rpc_submit_factory, rpc_call_factory, rpc_service_call_factory, identity, timeout_sec):
        self.id = id
        self.name = name
    ...
    def service_call(self, service_name):
        return self._rpc_service_call_factory(self.peer, self.identity, service_name, self._timeout_sec)
...
def subprocess_rpc_server_running(
    ...
    @contextmanager
    def _subprocess_rpc_server(name, identity, timeout_sec=10, start_timeout_sec=10):
        ...
        with subprocess_running(name, main_ref) as process:
            ...
            try:
                ...
                yield _RpcServerProcess(
                    ...
                    rpc_service_call_factory=rpc_service_call_factory,
                    identity=identity,
