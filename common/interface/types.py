...
class TRecord(Type):
    ...
    def __init__( self, fields=None, base=None, want_peer_arg=False ):
    ...
    def instantiate_impl( self, args=(), kw=None, check_unexpected=True ):
        ...
        ## print '*** instantiate', self, self.want_peer_arg, sorted(fields.keys()), sorted(f.name for f in self.fields)
